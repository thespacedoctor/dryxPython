import os
import nose
from .. import get_file_creation_modification_dates
...
class test_command_line(unittest.TestCase):
    ...
    def test_command_line_method_01(self):
        kwargs = {}
        kwargs["--pathToFile"] = pathToInputDir + "project_settings.yaml"
        get_file_creation_modification_dates.main(kwargs)

  ...
  var toggle = '[data-toggle=dropdown]',
    Dropdown = function(element) {
      ...
      $('html').on('click.dropdown.data-api', function() {
        $el.closest(":not(span)").removeClass('open')
      })
    }
...
// ============  CODEKIT IMPORTS  =========== //
//@codekit-prepend "jquery-1.10.1.js";
...
//@codekit-prepend "highlight.pack.js"
